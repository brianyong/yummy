...
public class Member {
   ...
   public Member( String memberName, String memberId, String memberPw, String memberPhone, String memberEmail) {
      super();
      this.memberName = memberName;
      this.memberId = memberId;
	...
	public Member( String memberName, String memberId, String memberPw, String memberPhone, String memberEmail, String memberGrade) {
		super();
		this.memberName = memberName;
		this.memberId = memberId;
		this.memberPw = memberPw;
