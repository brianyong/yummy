						...
						<li class="nav-item">
							<div class="dropdown">
								<button class="btn btn-light dropdown-toggle" type="button"
									...
									aria-haspopup="true" aria-expanded="false">더보기</button>
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<li class="nav-item active"><a class="nav-link"
									href="${contextPath}/order/orderList">주문내역</a></li>
								<li class="nav-item active"><a class="nav-link"
