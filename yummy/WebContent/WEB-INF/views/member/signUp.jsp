			...
			<div class="col-md-6 offset-md-3">
				...
				<form method="POST" action="signUp" class="needs-validation" name="signUpForm" onsubmit="return TOSvalidate();">
					...
					<table class="TOS_table">
						<tr>
							<td>
								<input type="checkbox" id="check_1" class="normal" name="ck" /> 
								<label for="check_1">[필수]야미 이용약관 동의</label>
							</td>
						</tr>
						<tr>
							<td>
								<input type="checkbox" id="check_2" class="normal" name="ck" /> 
								<label for="check_2">[필수]만 14세 이상 입니다</label>
							</td>
						</tr>
						<tr>
							<td>
								<input type="checkbox" id="check_3" class="normal" name="ck" /> 
								<label for="check_3">[필수]개인정보 수집 및 이용 동의</label>
							</td>
						</tr>
						<tr>
							<td>
								<input type="checkbox" id="check_4" class="normal" name="ck" /> 
								<label for="check_4">[필수]개인정보 제공 동의</label>
							</td>
						</tr>
						<tr>
							<td>
								<input type="checkbox" id="check_all" name="ck" /> 
...
제 1 조 (목적)
이 약관은 야미 주식회사(이하 “회사”)가 운영하는 사이버몰에서 제공하는 서비스와 이를 이용하는 회원의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
