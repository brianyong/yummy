...
<body>
   ...
   <ul class="all_body">
            ...
            <div class="category_menu">
               ...
               <c:forEach items="${list}" var="item" varStatus="vs">
                     ...
                     <div class="menu_conbox" data-toggle="modal" data-target="#exampleModal">
                        ...
                        <div class="Menu_salecost_content"><fmt:parseNumber var="price" integerOnly="true" value="${item.menuPrice-item.menuPrice*(item.menuSalePercent/100)}"/>${price}</div>
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <div class="modal-footer">
               ...
               <button type="button" class="btn btn-warning" onclick="fnRequest('cart', ${vs.count});">장바구니에 담기</button>
            </div>
         </div>
      </div>
   </div>
	...
	<form action="#" method="POST" name="requestForm">
		...
		<input type="hidden" name="menuSaleCost" id="menuSaleCost">
		<input type="hidden" name="menuAmount" id="menuAmount" >
